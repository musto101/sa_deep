...
# run the best model
train_features = pd.read_csv(opt.data_dir + '/cn_train_features.csv', header=0, index_col=False).to_numpy()
val_features = pd.read_csv(opt.data_dir + '/cn_val_features.csv', header=0, index_col=False).to_numpy()
test_features = pd.read_csv(opt.data_dir + '/cn_test_features.csv', header=0, index_col=False).to_numpy()
features = [train_features, val_features, test_features]

train_labels = pd.read_csv(opt.data_dir + '/cn_train_labels.csv', header=0, index_col=False).to_numpy()
val_labels = pd.read_csv(opt.data_dir + '/cn_val_labels.csv', header=0, index_col=False).to_numpy()
test_labels = pd.read_csv(opt.data_dir + '/cn_test_labels.csv', header=0, index_col=False).to_numpy()
labels = [train_labels, val_labels, test_labels]
