...
# save the data
train_X.to_csv('data/cn_train_features.csv', index=False)
val_X.to_csv('data/cn_val_features.csv', index=False)
test_X.to_csv('data/cn_test_features.csv', index=False)
...
train_y.to_csv('data/cn_train_labels.csv', index=False)
val_y.to_csv('data/cn_val_labels.csv', index=False)
test_y.to_csv('data/cn_test_labels.csv', index=False)
